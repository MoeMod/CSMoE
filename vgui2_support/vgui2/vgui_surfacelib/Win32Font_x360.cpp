...
int GetStyleFromParameters( int iFlags, int iWeight )
{
	...
	if ( iFlags & vgui2::ISurface::FONTFLAG_ITALIC )
		style |= XUI_FONT_STYLE_ITALIC;
	if ( iFlags & vgui2::ISurface::FONTFLAG_UNDERLINE )
...
bool CWin32Font::IsEqualTo(const char *windowsFontName, int tall, int weight, int blur, int scanlines, int flags)
{
		...
		m_iScanLines == scanlines )
	{
		...
		int validFlags = vgui2::ISurface::FONTFLAG_DROPSHADOW |
						vgui2::ISurface::FONTFLAG_OUTLINE |
						vgui2::ISurface::FONTFLAG_ROTARY |
						vgui2::ISurface::FONTFLAG_ITALIC |
						vgui2::ISurface::FONTFLAG_UNDERLINE;

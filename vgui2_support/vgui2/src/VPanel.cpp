...
namespace vgui2
{
    ...
    void VPanel::SetVirtualKeyBoardInputEnabled(bool state)
    {
        _vkbInput = state;
    }

    void VPanel::SetTouchInputEnabled(bool state)
    {
        _touchInput = state;
    }

    bool VPanel::IsVirtualKeyBoardInputEnabled()
    {
        return _vkbInput;
    }

    bool VPanel::IsTouchInputEnabled()
    {
        return _touchInput;
    }
#endif

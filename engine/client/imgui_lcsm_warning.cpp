...
void ImGui_LCSM_OnGUI(void)
{
	...
	ImGui::Begin("CSMoE LCSM Warning", nullptr, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_Modal);
	...
	if(ImGui::Selectable("退出游戏", false, 0, ImGuiUtils::GetScaledSize({0, 36})))
	{
		exit( 0 );
	}
	ImGui::End();

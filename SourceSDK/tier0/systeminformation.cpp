...
public:
	...
	SYSTEM_CALL_RESULT_t InitializeLoadModule( _TCHAR *pszModule, const char *pszFunction );
...
SYSTEM_CALL_RESULT_t CSysCallCacheEntry::InitializeLoadModule( _TCHAR *pszModule, const char *pszFunction )
{
	m_bInitialized = true;

...
#elif defined(_DEBUG)
    // xash impl
    extern void DBG_AssertFunction( qboolean fExpr, const char* szExpr, const char* szFile, int szLine, const char* szMessage );
    DBG_AssertFunction(false, pExpression, pFilename, line, "Assertion Failed");
#else

...
{
	"Counter-Strike BreakThrough Edition Mobile",
	...
	"Nexon for Counter-Strike Nexon: Zombies",
	"Uncle Mike for this powerful engine",
	"Flying With Gauss for Xash3D",
	"a1batross, mittorn, jeefo for CS16Client",
	"Nagist and s1lentq for successful CS16ND and ReGameDLL",
	"",
	"New BTE Team",

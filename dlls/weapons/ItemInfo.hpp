...
template<class StaticItemInfo>
constexpr ItemInfo BuildItemInfo(const StaticItemInfo &ii)
{
	return {
			ii.iSlot,
			ii.iPosition,
...
template<class StaticItemInfo>
constexpr ItemInfo BuildItemInfo()
{
	return {

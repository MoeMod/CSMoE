...
void CCannonTiger::Precache(void)
{
	...
	m_usFire = PRECACHE_EVENT(1, "events/cannontiger.sc");
}

int CCannonTiger::ExtractAmmo(CBasePlayerWeapon *pWeapon)
{
	if (m_iDefaultAmmo)
	{
...
void CCannonTiger::PrimaryAttack(void)
{
	CannonTigerFire(0, 3.5s, FALSE);
}

void CCannonTiger::CannonTigerFire(float flSpread, duration_t flCycleTime, BOOL fUseAutoAim)
{
	m_bDelayFire = true;

...
public:
	...
	bool RadiusDamage(entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int iClassIgnore, int bitsDamageType, float flRadius);
	void
...
#ifndef CLIENT_DLL
	EHANDLE m_hSpearAttached;
#endif
	time_point_t m_flNextSpearPush;
};

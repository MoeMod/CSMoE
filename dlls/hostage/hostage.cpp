		...
		if (player == NULL || player->m_iTeam == CT)
		{
			...
			if (m_bRescueMe)
			{
				...
				if (player != NULL)
				{
					...
					UTIL_LogPrintfDetail("\"%s<%i><%s><CT>\" triggered \"Rescued_A_Hostage\"\n", STRING(player->pev->netname),
...
void CHostage::MoveToward(const Vector &vecLoc)
{
	...
	UTIL_MakeVectorsPrivate(vecAng, vecFwd, vecRight, vecUp);

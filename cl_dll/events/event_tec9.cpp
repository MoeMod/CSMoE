...
static const char *SOUNDS_NAME = "weapons/csgo_ports/tec9/tec9-1.wav";

void EV_FireTec9( event_args_s *args)
{
	...
	if (EV_IsLocal(idx))
	{
		++g_iShotsFired;
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation(Com_RandomLong(TEC9_SHOOT1, TEC9_SHOOT3), 2);

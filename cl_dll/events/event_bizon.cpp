...
static const char *SOUNDS_NAME = "weapons/csgo_ports/bizon/bizon-1.wav";

void EV_FireBizon(event_args_s *args)
{
	...
	{
		++g_iShotsFired;
		gEngfuncs.pEventAPI->EV_WeaponAnimation(Com_RandomLong(BIZON_SHOOT1, BIZON_SHOOT3), 2);
		EV_MuzzleFlash();

...
static const char *SOUNDS_NAME = "weapons/csgo_ports/mag7/mag7-1.wav";

void EV_FireMag7(event_args_s *args)
{
	...
	if ( EV_IsLocal( idx ) )
	{
		++g_iShotsFired;
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation(Com_RandomLong(MAG7_FIRE1, MAG7_FIRE2), 2);

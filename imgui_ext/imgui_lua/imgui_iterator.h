...
CALL_FUNCTION(DragFloat, bool, label, v, v_speed, v_min, v_max, display_format, (float)power)
PUSH_BOOL(ret)
END_FLOAT_POINTER(v)
PUSH_LAST_BOOL(ret)
END_IMGUI_FUNC
...
OPTIONAL_LABEL_ARG(display_format, "%.3f")
OPTIONAL_NUMBER_ARG(power, 1.0f)
CALL_FUNCTION(DragFloat2, bool, label, v, v_speed, v_min, v_max, display_format, (float)power)
PUSH_BOOL(ret)
END_FLOAT_ARRAY2(v)
PUSH_LAST_BOOL(ret)
END_IMGUI_FUNC
...
OPTIONAL_LABEL_ARG(display_format, "%.3f")
OPTIONAL_NUMBER_ARG(power, 1.0f)
CALL_FUNCTION(DragFloat3, bool, label, v, v_speed, v_min, v_max, display_format, (float)power)
PUSH_BOOL(ret)
END_FLOAT_ARRAY3(v)
PUSH_LAST_BOOL(ret)
END_IMGUI_FUNC
...
OPTIONAL_LABEL_ARG(display_format, "%.3f")
OPTIONAL_NUMBER_ARG(power, 1.0f)
CALL_FUNCTION(DragFloat4, bool, label, v, v_speed, v_min, v_max, display_format, (float)power)
PUSH_BOOL(ret)
END_FLOAT_ARRAY4(v)
PUSH_LAST_BOOL(ret)
END_IMGUI_FUNC
...
OPTIONAL_NUMBER_ARG(power, 1.0f)
CALL_FUNCTION(DragFloatRange2, bool, label, v_current_min, v_current_max, v_speed, v_min, v_max, display_format, display_format_max, (float)power)
PUSH_BOOL(ret)
...
OPTIONAL_LABEL_ARG(display_format, "%.3f")
OPTIONAL_NUMBER_ARG(power, 1.0f)
CALL_FUNCTION(SliderFloat, bool, label, v, v_min, v_max, display_format, (float)power)
PUSH_BOOL(ret)
END_FLOAT_POINTER(v)
PUSH_LAST_BOOL(ret)
END_IMGUI_FUNC
...
OPTIONAL_LABEL_ARG(display_format, "%.3f")
OPTIONAL_NUMBER_ARG(power, 1.0f)
CALL_FUNCTION(SliderFloat2, bool, label, v, v_min, v_max, display_format, (float)power)
PUSH_BOOL(ret)
END_FLOAT_ARRAY2(v)
PUSH_LAST_BOOL(ret)
END_IMGUI_FUNC
...
OPTIONAL_LABEL_ARG(display_format, "%.3f")
OPTIONAL_NUMBER_ARG(power, 1.0f)
CALL_FUNCTION(SliderFloat3, bool, label, v, v_min, v_max, display_format, (float)power)
PUSH_BOOL(ret)
END_FLOAT_ARRAY3(v)
PUSH_LAST_BOOL(ret)
END_IMGUI_FUNC
...
OPTIONAL_LABEL_ARG(display_format, "%.3f")
OPTIONAL_NUMBER_ARG(power, 1.0f)
CALL_FUNCTION(SliderFloat4, bool, label, v, v_min, v_max, display_format, (float)power)
PUSH_BOOL(ret)
END_FLOAT_ARRAY4(v)
PUSH_LAST_BOOL(ret)
END_IMGUI_FUNC
...
LABEL_ARG(name)
OPTIONAL_ENUM_ARG(flags, 0)
CALL_FUNCTION(BeginTabBar, bool, name, flags)
...
OPTIONAL_BOOL_POINTER_ARG(p_open)
OPTIONAL_ENUM_ARG(flags, 0)
CALL_FUNCTION(BeginTabItem, bool, name, p_open, flags)
